...
class Usuario extends \UsuarioBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UsuarioBundle\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'UsuarioBundle\\Entity\\Usuario' . "\0" . 'username', '' . "\0" . 'UsuarioBundle\\Entity\\Usuario' . "\0" . 'email', '' . "\0" . 'UsuarioBundle\\Entity\\Usuario' . "\0" . 'password', '' . "\0" . 'UsuarioBundle\\Entity\\Usuario' . "\0" . 'plainPassword'];
        }
