...
namespace Proxies\__CG__\ProfesorBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Profesor extends \ProfesorBundle\Entity\Profesor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProfesorBundle\\Entity\\Profesor' . "\0" . 'id', '' . "\0" . 'ProfesorBundle\\Entity\\Profesor' . "\0" . 'nombre', '' . "\0" . 'ProfesorBundle\\Entity\\Profesor' . "\0" . 'apellidos', '' . "\0" . 'ProfesorBundle\\Entity\\Profesor' . "\0" . 'departamento', '' . "\0" . 'ProfesorBundle\\Entity\\Profesor' . "\0" . 'alumno'];
        }
